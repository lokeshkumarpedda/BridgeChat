...
public class Controller: NSObject
{
    ...
    public func getAdminNames(callback: (Result : String, Result1 : String) -> Void)
    {
        //getting reference of firebase
        mRef = mRestCallObj.getReferenceFirebase()
        var count = 0
    ...
    public func getMessage(adminName : String, userName : String, callback: (Result : String,Result1 : Int) -> Void)
    {
        //getting reference of firebase
        mRef = mRestCallObj.getReferenceFirebase()
