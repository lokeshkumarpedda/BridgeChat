...
//            self.stopActivityIndicator()
    ...
    public func updateAdminStatus(notification: NSNotification)
    {
    ...
    override public func viewWillAppear(animated: Bool)
    {
        ...
        let backgroundImage = UIImage(named: "bacground.jpg")
    ...
    public func getMessagesDetails()
    {
